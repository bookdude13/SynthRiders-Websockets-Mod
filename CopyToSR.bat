...
@REM set DEPENDENCY_DLLS=%DEPENDENCY_DLLS% %BUILD_DIR%\Microsoft.Extensions.Configuration.CommandLine.dll
set DEPENDENCY_DLLS=%DEPENDENCY_DLLS% %BUILD_DIR%\Microsoft.Extensions.Configuration.dll
@REM set DEPENDENCY_DLLS=%DEPENDENCY_DLLS% %BUILD_DIR%\Microsoft.Extensions.Configuration.EnvironmentVariables.dll
...
@REM set DEPENDENCY_DLLS=%DEPENDENCY_DLLS% %BUILD_DIR%\Microsoft.Extensions.Configuration.UserSecrets.dll
...
@REM set DEPENDENCY_DLLS=%DEPENDENCY_DLLS% %BUILD_DIR%\Microsoft.Extensions.Logging.Configuration.dll
@REM set DEPENDENCY_DLLS=%DEPENDENCY_DLLS% %BUILD_DIR%\Microsoft.Extensions.Logging.Console.dll
@REM set DEPENDENCY_DLLS=%DEPENDENCY_DLLS% %BUILD_DIR%\Microsoft.Extensions.Logging.Debug.dll
@REM set DEPENDENCY_DLLS=%DEPENDENCY_DLLS% %BUILD_DIR%\Microsoft.Extensions.Logging.dll
